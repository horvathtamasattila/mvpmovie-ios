                ...
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    HStack(spacing: 16) {
                        HStack(spacing: 4) {
                            ...
                            Text(viewModel.isSaved ? "detail_saved_button".localized : "detail_save_button".localized)
                        }
                        .onTapGesture {
                        ...
                        HStack(spacing: 4) {
                            ...
                            Text(viewModel.isHidden ? "detail_hidden_button".localized : "detail_hide_button".localized)
                        }
                        .onTapGesture {
